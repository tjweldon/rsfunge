...
mod visual {
    ...
    fn view(app: &App, _model: &Model, frame: Frame) {
        ...
        for row_idx in 0..rows {
            ...
            let (start, end) = (c_rect.left.add(vertical), c_rect.right.add(vertical));
        ...
        for col_idx in 0..cols {
            ...
            let (start, end) = (c_rect.top.add(horizontal), c_rect.btm.add(horizontal));
        ...
        draw.rect().w_h(C_WIDTH, C_HEIGHT).color(GREEN).xy(ip_vec);
